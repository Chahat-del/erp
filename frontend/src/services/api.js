...
export const addComment = (id, data) => api.post(`/tasks/${id}/comment`, data);
...
export const reviewReport = (id, data) => api.patch(`/reports/${id}/review`, data);

// Dashboard
export const getAdminDashboard = () => api.get('/dashboard/admin');
export const getEmployeeDashboard = () => api.get('/dashboard/employee');
export const getPerformance = (id) => api.get(`/dashboard/performance/${id}`);
